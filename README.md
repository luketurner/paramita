...
4. Set "Taps to Refresh" to zero to maintain a clean display when updating weather, etc.
5. Launch the app and put your device in landscape mode (I use the case as a stand).
6. Ideally, plug it in. Otherwise you'll need to regularly recharge it.
